  ...
  return (
    <div>
      ...
      {isFetchedInfo && !addressInfo && (
        <div className="pl-4 pr-4 fade-in-1s transition-all outline-offset-1 outline-4 hover:outline-2 outline-[#14892e] hover:outline-[#95ed81] mt-2 items-center justify-center min-w-75 sm:min-w-100 md:min-w-125 lg:min-w-162.5 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl mx-auto font-semibold rounded-lg bg-gray-50 pb-2 pt-2">
