        ...
        <div>
            ...
            {isFetched && transactionData && hashData ? (
                <div className="mx-auto max-w-7xl px-6 lg:px-8 mt-4 sm:mt-0 text-gray-100">
                    <div className="has-tooltip text-2xl mt-2 sm:text-3xl md:text-4xl mb-2 text-blue-950 dark:text-blue-500 font-mono tracking-wide">
                        <span className="tooltip -ml-16 tracking-tighter dark:bg-black dark:text-white/80 dark:border dark:border-gray-100/30">
                            {hashData.hash}
                        </span>
                        ...
                        <button
                            ...
                            className="ml-1"
                        >
                            <DocumentDuplicateIcon className="w-4 h-4 text-gray-800 hover:text-gray-600 dark:text-gray-200 dark:hover:text-gray-400" />
                        </button>
                    ...
                    <div className="font-serif mb-6 sm:mb-10">
                        <p className="mt-2">
                            <Link
                                ...
                                className="text-blue-900 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-300 font-semibold md:text-lg tracking-wide"
                            >
                                {parseNumber(hashData.blockNumber)}
                            </Link>
                        </p>
                        <p className="font-sans text-base md:text-lg text-blue-900 dark:text-blue-500/60 tracking-tighter mt-1">
                        ...
                        <div className="mt-5">
                            <p className="flex items-center justify-center bg-emerald-300 pt-3 pb-3 pr-6 pl-3 rounded-lg mx-auto max-w-xs">
                                ...
                                <div className="ml-2 break-words">
                                    ...
                                    >
                                        <span className="tooltip dark:bg-black dark:text-white/80 dark:border dark:border-gray-100/30">{hashData.from}</span>
                        ...
                        <div className="mt-6">
                            <div className="flex items-center justify-center bg-[#e76e9e] pt-3 pb-3 pr-3 pl-6 rounded-lg mx-auto max-w-xs">
                                ...
                                <div className="ml-2">
                                    ...
                                    >
                                        <span className="tooltip dark:bg-black dark:text-white/80 dark:border dark:border-gray-100/30">
                                            {hashData.to ??
                                                "0x0000000000000000000000000000000000000000"}
                                        </span>
                                        ...
                                        (token: TokenTransfer) => (
                                            ...
                                            >
                                                <div>
                                                    ...
                                                    >
                                                        <div className="tooltip dark:bg-black dark:text-white/80 dark:border dark:border-gray-100/30">{token.from.hash}</div>
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        <div className="tooltip dark:bg-black dark:text-white/80 dark:border dark:border-gray-100/30">{token.to.hash}</div>
