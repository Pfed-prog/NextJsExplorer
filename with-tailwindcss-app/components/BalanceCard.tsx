...
export const BalanceCard = (props: ContractProps) => {
  ...
  return (
    <div className="fade-in-1s items-center justify-center max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto font-semibold pt-2 pb-2 rounded-lg drop-shadow-md bg-gray-50 sm:p-6 mb-8">
