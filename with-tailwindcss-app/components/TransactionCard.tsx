                            ...
                            <tbody>
                                {addressTransactions?.map((tx: AddressTransaction) => (
                                    <tr key={tx.hash}>
                                        ...
                                        <td className="border-t border-gray-400 dark:border-gray-700 hidden px-3 py-3.5 text-sm text-gray-600 dark:text-gray-300 lg:table-cell">
                                            {Number(tx.gas_used).toLocaleString("es-US") ?? 0}
                                            <p className="mt-2">{parseWei(tx.gas_price)} Gwei</p>
                                        </td>
                                        <td className="border-t border-gray-400 dark:border-gray-700 hidden px-3 py-3.5 text-sm text-gray-500 dark:text-gray-300 lg:table-cell">
